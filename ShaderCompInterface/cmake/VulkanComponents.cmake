...
if(Vulkan_FOUND)
    ...
    if(UNIX)
        ...
        if(glslang_FOUND)
            ...
            target_link_libraries(${project_exe_name} PRIVATE glslang::glslang)
        else()
            ...
            if(glslang_lib)
                ...
                target_link_libraries(${project_exe_name} PRIVATE ${glslang_lib})
            else()
            ...
            if(glslang_path)
                ...
                target_include_directories(${project_exe_name} PRIVATE ${glslang_path})
            else()
                message(FATAL_ERROR "Could not fine glslang path")
            endif()
        endif()

        target_link_libraries(${project_exe_name} PRIVATE Vulkan::shaderc_combined)
    else()
        target_link_libraries(${project_exe_name} PRIVATE Vulkan::glslang Vulkan::shaderc_combined)
    endif()
else()
    find_package(glslang)
    ...
    if (shaderc_lib)
        ...
        target_link_libraries(${project_exe_name} PRIVATE ${shaderc_lib})
    else()
    ...
    if(shaderc_path)
        ...
        target_include_directories(${project_exe_name} PRIVATE ${shaderc_path})
    else()
