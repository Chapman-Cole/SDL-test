...
if(Vulkan_FOUND)
    ...
    if(UNIX)
        ...
        if(glslang_FOUND)
            ...
            find_library(glslang_lib NAMES glslang PATHS /usr/lib)
            if(glslang_lib)
            ...
            find_path(glslang_path NAMES glslang PATHS /usr/lib)
            if(glslang_path)
    ...
    if(glslang_FOUND)
        ...
        find_library(glslang_lib NAMES glslang PATH /usr/lib)
        if(glslang_lib)
            message(STATUS "Found glslang library at ${glslang_lib}")
        else()
            message(FATAL_ERROR "Could not find glslang library")
