...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char* argv[]) {
    ...
    graphics_pipeline_attach_vertex_shader(&graphicsPipeline, &STRING("../shaders/test.vert"), &STRING("main"), SHADER_COMPILATION_GLSL_PATH);
    graphics_pipeline_attach_fragment_shader(&graphicsPipeline, &STRING("../shaders/test.frag"), &STRING("main"), SHADER_COMPILATION_GLSL_PATH);
